...
//CORE_REFERENCE_IMPORT-initializeFirebase
import { initializeFirebase } from '../sd-services/initializeFirebase';
...
export const appProviders = [
  ...
  //CORE_REFERENCE_PUSH_TO_PRO_ARRAY-initializeFirebase
  initializeFirebase,
];
